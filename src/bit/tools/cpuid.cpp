...
bool bit::tools::is_cpuid_supported()
  noexcept
{
  __try{
...
void bit::tools::execute_cpuid( cpuid_info* result, u32 function, u32 subfunction )
{
...
void bit::tools::execute_cpuid( cpuid_info* result,
                                stl::u32 function,
                                stl::u32 subfunction )
{
  asm volatile(
...
void bit::tools::execute_cpuid( cpuid_info*, u32, u32 )
{
